...
export const PrivacyPolicy = () => {
  ...
  return (
    <Container id='privacy_policy_id'>
      <Header>Privacy Policy for AIC Group</Header>
      <p>At AIC Group, accessible from www.aicgroup.co.in, one of our main priorities is the
      privacy of our visitors. This Privacy Policy document contains types of information that is
      collected and recorded by AIC Group and how we use it.</p>
      ...
      website with regards to the information that they shared and/or collect in AIC Group. This
      ...
      <p>AIC Group follows a standard procedure of using log files. These files log visitors when
      ...
      <p>Like any other website, AIC Group uses 'cookies'. These cookies are used to store
      ...
      <SubHeader>Advertising Partners Privacy Policies</SubHeader>
      ...
      Web Beacons that are used in their respective advertisements and links that appear on AIC
      Group, which are sent directly to users' browser. They automatically receive your IP address
      ...
      <p>Note that AIC Group has no access to or control over these cookies that are used by
      third-party advertisers.</p>
      <SubHeader>Third Party Privacy Policies</SubHeader>
      <p>AIC Group's Privacy Policy does not apply to other advertisers or websites. Thus, we are
      ...
      online activity.</p>
      <p>AIC Group does not knowingly collect any Personal Identifiable Information from children
