...
export const TermsConditions = () => {
  ...
  return (
    <Container id='terms_conditions_id'>
      <Header><strong>Terms and Conditions</strong></Header>
      <p>Welcome to AIC Group!</p>
      <p>These terms and conditions outline the rules and regulations for the use of Traction
      Monkey's Website, located at www.aicgroup.co.in.</p>
      <p>By accessing this website we assume you accept these terms and conditions. Do not
      continue to use AIC Group if you do not agree to take all of the terms and conditions stated
      on this page.</p>
      ...
      to same.</p>
      <SubHeader><strong>Cookies</strong></SubHeader>
      <p>We employ the use of cookies. By accessing AIC Group, you agreed to use cookies in
      agreement with the Traction Monkey's Privacy Policy. </p>
      ...
      cookies.</p>
      <SubHeader><strong>License</strong></SubHeader>
      <p>Unless otherwise stated, Traction Monkey and/or its licensors own the intellectual
      property rights for all material on AIC Group. All intellectual property rights are reserved. You
      may access this from AIC Group for your own personal use subjected to restrictions set in
      these terms and conditions.</p>
      <p>You must not:</p>
      <ul>
      <li>Republish material from AIC Group</li>
      <li>Sell, rent or sub-license material from AIC Group</li>
      <li>Reproduce, duplicate or copy material from AIC Group</li>
      <li>Redistribute content from AIC Group</li>
      </ul>
      ...
      information in certain areas of the website. Traction Monkey does not filter, edit, publish or
      review Comments prior to their presence on the website. Comments do not reflect the views
      and opinions of Traction Monkey,its agents and/or affiliates. Comments reflect the views and
      opinions of the person who post their views and opinions. To the extent permitted by
      applicable laws, Traction Monkey shall not be liable for the Comments or for any liability,
      ...
      <p>Traction Monkey reserves the right to monitor all Comments and to remove any
      ...
      <p>You hereby grant Traction Monkey a non-exclusive license to use, reproduce, edit and
      authorize others to use, reproduce and edit any of your Comments in any and all forms,
      formats or media.</p>
      <SubHeader><strong>Hyperlinking to our Content</strong></SubHeader>
      ...
      visibility of the hyperlink compensates the absence of Traction Monkey; and (d) the link is in
      ...
      linking to our website, you must inform us by sending an e-mail to Traction Monkey. Please
      ...
      on our site to which you would like to link. Wait 2-3 weeks for a response.</p>
      ...
      <p>No use of Traction Monkey's logo or other artwork will be allowed for linking absent a
      trademark license agreement.</p>
      <SubHeader><strong>iFrames</strong></SubHeader>
      ...
      <SubHeader><strong>Content Liability</strong></SubHeader>
      ...
      which infringes, otherwise violates, or advocates the infringement or other violation of, any
      third party rights.</p>
      <SubHeader><strong>Your Privacy</strong></SubHeader>
      <p>Please read Privacy Policy</p>
      <SubHeader><strong>Reservation of Rights</strong></SubHeader>
      ...
      and conditions.</p>
      <SubHeader><strong>Removal of links from our website</strong></SubHeader>
      ...
      <SubHeader><strong>Disclaimer</strong></SubHeader>
