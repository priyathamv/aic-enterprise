...
public class InstrumentationProductServiceImpl implements ProductService2<InstrumentationProduct> {
    ...
    @Override
    public InstrumentationProduct getNextProductDetails(String productId, LocalDateTime updateTs, boolean isNext) {
        ...
        List<InstrumentationProduct> instrumentationProducts = mongoTemplate.find(query, InstrumentationProduct.class);
        return instrumentationProducts.isEmpty() ? null : instrumentationProducts.get(0);
    }
